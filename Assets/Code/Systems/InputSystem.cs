namespace ViveDB {
    ...
    public partial class InputSystem
    {
		...
		protected override void InputSystemShootEventHandler(ViveDB.ShootEvent data, Wands group) {
			if ((i % 5 == 0)) {
		...
		protected override void InputSystemTeleportEventHandler(ViveDB.TeleportEvent data, Wands group) {
			Debug.Log("Teleport");
		...
		protected override void InputSystemMoveEventHandler(MoveEvent data, Player group) {
			...
			group.transform.rotation = Quaternion.Euler(0, mainCamera.transform.rotation.eulerAngles.y, 0);
